...
func Init(app *fiber.App) {
	...
	app.Post("/api/account/sign-out", SignOut)
	...
	app.Get("/api/account/mfa/recovery-codes", GetRecoveryCodes)
	app.Post("/api/account/mfa/recovery-codes", RenewRecoveryCodes)
